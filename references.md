...
* Compound Engineering
    + link: ["Compound Engineering: The AI-native engineering philosophy"](https://every.to/guides/compound-engineering)
    + [X post](https://x.com/petergyang/status/2020520605905567854?s=20)
* Shaping Methodology
    + link: ["Shaping 0-1 with Claude Code"](https://x.com/rjs/status/2020184079350563263?s=20)
    + link: [X post](https://x.com/ClaytonFarr/status/2020532757886361825?s=20)
    + [SKILL.md](https://github.com/rjs/shaping-skills/blob/main/shaping/SKILL.md): "Use this methodology when collaboratively shaping a solution with the user - iterating on problem definition (requirements) and solution options (shapes)."
* Agentic Engineering
    + link: ["GLM-5: From Vibe Coding to Agentic Engineering"](https://z.ai/blog/glm-5)
* Agentic coding
    + link: [X post](https://x.com/batuhan/status/2020498763010437311?s=20)
